...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    ...
    get$onKeyPress: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, "keypress", false), [null]);
    },
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new F.main_closure()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t3 = t2.get$onKeyUp(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new F.main_closure0()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    t1 = t2.get$onKeyPress(t1);
  ...
  log: function(st) {
    ...
    t3 = $.get$textArea();
    t3.toString;
    t3 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.scrollHeight));
    t1.toString;
    t1.scrollTop = C.JSNumber_methods.toInt$0(C.JSInt_methods.roundToDouble$0(t3));
  },
  main_closure: {
    "^": "Closure:19;",
    call$1: function($event) {
      var t1, t2, t3;
      if (J.get$keyCode$x($event) === 38 || $event.keyCode === 40) {
        $event.preventDefault();
        if ($event.keyCode === 38)
          $.scrollbackIndex = P.min($.scrollbackIndex + 1, $.get$scrollback().length - 1);
        if ($event.keyCode === 40)
          $.scrollbackIndex = P.max($.scrollbackIndex - 1, 0);
        t1 = $.get$inputField();
        t2 = $.get$scrollback();
        t3 = $.scrollbackIndex;
        if (t3 < 0 || t3 >= t2.length)
          return H.ioore(t2, t3);
        J.set$value$x(t1, t2[t3]);
      }
    }
  },
  main_closure0: {
    ...
    call$1: function($event) {
      var t1, t2;
      if (W.KeyCode_isCharacterKey(J.get$keyCode$x($event))) {
        t1 = $.scrollbackIndex;
        if (t1 !== 0) {
          $.scrollbackIndex = 0;
          t1 = 0;
        ...
        if (t1 === 0) {
          t1 = $.get$scrollback();
          t2 = J.trim$0$s(J.get$value$x($.get$inputField()));
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          t1[0] = t2;
        }
  ...
  main_closure1: {
    "^": "Closure:19;",
    call$1: function($event) {
      var input, t1, t2, index;
      input = J.replaceAll$2$s(J.get$value$x($.get$inputField()), new H.JSSyntaxRegExp("\\s+", H.JSSyntaxRegExp_makeNative("\\s+", false, true, false), null, null), " ");
      if (J.get$keyCode$x($event) === 13 && J.get$length$asx(input) !== 0) {
        t1 = $.get$scrollback();
        t2 = t1.length;
        if (0 >= t2)
          return H.ioore(t1, 0);
        t1[0] = input;
        index = H.Lists_lastIndexOf(t1, input, t2 - 1);
        if (index !== 0) {
          t1 = $.get$scrollback();
        ...
        t1.splice(0, 0, "");
        $.scrollbackIndex = 0;
        J.set$value$x($.get$inputField(), "");
        F.log("Committed: " + H.S($.get$scrollback()));
      }
    }
  }
},
...
Isolate.$lazy($, "scrollback", "scrollback", "get$scrollback", function() {
  return [""];
});
Isolate.$lazy($, "inputField", "inputField", "get$inputField", function() {
  return document.querySelector("#DemoInput");
});
Isolate.$lazy($, "textArea", "textArea", "get$textArea", function() {
  return document.querySelector("#DemoTextArea");
});
