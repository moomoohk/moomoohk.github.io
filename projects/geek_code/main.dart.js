...
["geek_code", "package:geek_code/geek_code.dart", , Z, {
  "^": "",
  GeekCode__determineTypeList: function(types) {
    return types;
  },
  BasicGeekCodeCategoryBuilder: {
    "^": "Object;_notRigid,_living,_noKnowledge,_refuse,_crossover"
  },
  BasicGeekCodeCategory: {
    "^": "Object;_builder<,_grade",
    toString$0: ["super$BasicGeekCodeCategory$toString$0", function(_) {
      var t1 = this._grade;
      t1 = t1 != null ? J.toString$0(t1) : "";
      this.get$_builder();
      t1 += this.get$_builder()._living ? "$" : "";
      return t1 + (this.get$_builder()._notRigid ? "@" : "");
    }]
  },
  ...
  GeekCodeCategoryBuilder: {
    ...
    grade$1: function(grade) {
      ...
      t2 = this.maxGrade;
      if (t1 > t2)
        throw H.wrapException(P.ArgumentError$("minGrade[" + t1 + "] must be smaller than maxGrade[" + t2 + "}]!"));
      if (grade != null) {
        t3 = grade.grade;
        t4 = J.getInterceptor$n(t3);
        t3 = t4.$lt(t3, t1) || t4.$gt(t3, t2);
      } else
        t3 = false;
      if (t3)
        throw H.wrapException(P.ArgumentError$("grade[" + H.S(grade.grade) + "] must fall within bounds: minGrade[" + t1 + "], maxGrade[" + t2 + "]!"));
      return this.subValidate$3(grade, this._refuse, this._noKnowledge);
    }
  },
  GeekCodeCategory: {
    "^": "BasicGeekCodeCategory;_builder:GeekCodeCategory__builder<,code>,_builder,_grade",
    toString$0: ["super$GeekCodeCategory$toString$0", function(_) {
      var t1 = this.get$_builder()._refuse ? "!" : "";
      t1 = C.JSString_methods.$add(t1, this.code) + this.super$BasicGeekCodeCategory$toString$0(this);
      t1 += this.get$_builder()._noKnowledge ? "?" : "";
      this.get$_builder();
      return t1;
    }]
  },
  ...
  GeekCode: {
    "^": "Object;",
    generate$1: ["super$GeekCode$generate$1", function(version) {
  ...
  GeekCodeError: {
    "^": "ArgumentError;_hasValue,invalidValue,name,message",
    static: {GeekCodeError$: function(message) {
        return new Z.GeekCodeError(false, null, null, message);
      }}
  },
  GeekCodeGrade: {
    "^": "Object;grade",
...
["geek_code.v312", "package:geek_code/geek_code_312.dart", , V, {
  "^": "",
  getBuilder: function(categoryCode) {
    var t1;
    switch (categoryCode) {
      case "d":
  ...
  Gender: {
    "^": "Object;index",
    toString$0: function(_) {
      return C.Map_sgWv6.$index(0, this.index);
    }
  },
  SexGeekCodeCategory: {
  ...
  ShapeGeekCodeCategoryBuilder: {
    ...
    subValidate$3: function(grade, refuse, noKnowledge) {
      ...
      if (!refuse && !noKnowledge) {
        if (grade == null)
          throw H.wrapException(Z.GeekCodeError$("grade (height) not set!"));
        t1 = this._roundness;
        if (t1 == null)
          throw H.wrapException(Z.GeekCodeError$("roundness not set!"));
  ...
  ShapeGeekCodeCategory: {
    "^": "GeekCodeCategory;_v312$_builder,_roundness,GeekCodeCategory__builder,code,_builder,_grade",
    toString$0: function(_) {
      var t1, t2;
      t1 = this.super$GeekCodeCategory$toString$0(this);
      t2 = this._v312$_builder;
      return t1 + (!t2._refuse && !t2._noKnowledge ? ":" + J.toString$0(this._roundness) : "");
    }
  },
  ...
  UnixType: {
    "^": "Object;index",
    toString$0: function(_) {
      return C.Map_mCsx4.$index(0, this.index);
    }
  },
...
["", "main.dart", , F, {
  ...
  generate: function() {
    ...
    try {
      ...
      for (t1 = categories, t1 = new J.ArrayIterator(t1, J.get$length$asx(t1), 0, null); t1.moveNext$0();) {
        ...
        if (t3.containsKey$1(t4.get$code(t2)))
          H.throwExpression(Z.GeekCodeError$(C.JSString_methods.$add("Geek Code already contains category[", t4.get$code(t2)) + "]!"));
        t3.$indexSet(0, t4.get$code(t2), t2);
      }
      t1 = $.get$output();
      t2 = $.code;
  ...
  getTypes: function() {
    ...
    t1 = $.get$allTypes();
    t1 = H.setRuntimeTypeInfo(new H.WhereIterable(t1, new F.getTypes_closure1(selectedTypeStrings)), [H.getTypeArgumentByIndex(t1, 0)]);
    return P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "IterableBase", 0));
  },
  getCategories: function() {
    var t1 = new W._FrozenElementList(document.querySelectorAll("select.grade"));
    t1 = t1.where$1(t1, new F.getCategories_closure());
  ...
  getCategories_closure0: {
    ...
    call$1: function(e) {
      ...
      if (selectedModifier != null) {
        ...
        switch (modifier) {
          case "noKnowledge":
            if (builder._notRigid || builder._living)
              H.throwExpression(Z.GeekCodeError$("Can't noKnowledge while (notRigid || living)!"));
            builder._noKnowledge = true;
            return builder.grade$1(null);
          case "refuse":
            if (builder._notRigid || builder._living)
              H.throwExpression(Z.GeekCodeError$("Can't refuse while (notRigid || living)!"));
            builder._refuse = true;
            return builder.grade$1(null);
          default:
            switch (t1.get$name(e)) {
              case "d":
                switch (modifier) {
                  case "sameClothes":
                    H.interceptedTypeCast(builder, "$isDressGeekCodeCategoryBuilder")._sameClothes = true;
                    break;
                  case "crossDresser":
                    H.interceptedTypeCast(builder, "$isDressGeekCodeCategoryBuilder")._crossDresser = true;
                    break;
                }
                break;
            }
...
C.Map_mCsx4 = new H.GeneralConstantMap([0, "UnixType.B", 1, "UnixType.L", 2, "UnixType.U", 3, "UnixType.A", 4, "UnixType.V", 5, "UnixType.H", 6, "UnixType.I", 7, "UnixType.O", 8, "UnixType.S", 9, "UnixType.C", 10, "UnixType.X", 11, "UnixType.OTHER", 12, "UnixType.NOT_SPECIFIED"]);
C.Map_sgWv6 = new H.GeneralConstantMap([0, "Gender.x", 1, "Gender.y", 2, "Gender.z"]);
C.UnixType_0 = new V.UnixType(0);
C.UnixType_1 = new V.UnixType(1);
C.UnixType_10 = new V.UnixType(10);
C.UnixType_11 = new V.UnixType(11);
C.UnixType_12 = new V.UnixType(12);
C.UnixType_2 = new V.UnixType(2);
C.UnixType_3 = new V.UnixType(3);
C.UnixType_4 = new V.UnixType(4);
C.UnixType_5 = new V.UnixType(5);
C.UnixType_6 = new V.UnixType(6);
C.UnixType_7 = new V.UnixType(7);
C.UnixType_8 = new V.UnixType(8);
C.UnixType_9 = new V.UnixType(9);
